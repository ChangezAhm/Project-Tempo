...
// Server-side only. Reads the reviewed contract fields (the data model
// rendered for human review) from the parser service.
...
export async function GET(
  ...
  try {
    const res = await fetch(`${PARSER_URL}/contract/${id}/fields`, {
