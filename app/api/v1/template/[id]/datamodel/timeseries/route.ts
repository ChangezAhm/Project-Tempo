...
// Server-side only. Reads the data model projected as a TIME SERIES
// (per tab: metrics × periods, with an actual/budget/forecast dimension)
...
export async function GET(
  ...
  try {
    const res = await fetch(`${PARSER_URL}/datamodel/${id}/timeseries`, {
